...
# Extra keyword passed to chat templates that support it. Keep None for Llama.
HF_ENABLE_THINKING = None

# --- Models to evaluate --------------------------------------------------
# Each entry: (model_id, num_ctx). For Hugging Face, model_id is usually a
# Hub repo id such as "meta-llama/Meta-Llama-3.1-8B-Instruct", or a local
# model directory.
...
# --- Run parameters ------------------------------------------------------
RUNS_PER_CELL = 5           # repetitions per (model, language, scenario)
TEMPERATURE   = 0
TOP_P         = 1
